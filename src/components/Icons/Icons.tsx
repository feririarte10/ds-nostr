...
export const ChevronLeftBlue = () => (
  <svg width={10} height={17} fill='none' xmlns='http://www.w3.org/2000/svg'>
    <path
      d='M1.977.326A1.127 1.127 0 0 0 1.164 0C.52 0 0 .498 0 1.13c0 .317.137.605.362.825l6.85 6.555-6.85 6.535c-.225.22-.362.518-.362.824C0 16.502.519 17 1.164 17c.323 0 .597-.115.813-.326l7.612-7.283c.274-.249.401-.556.411-.891 0-.335-.137-.623-.411-.882L1.977.326Z'
      fill='currentColor'
    />
  </svg>
);

export const ChevronRightBlue = () => (
  <svg width={10} height={17} fill='none' xmlns='http://www.w3.org/2000/svg'>
    <path
      d='M8.023 16.674c.216.211.49.326.813.326C9.48 17 10 16.502 10 15.87a1.15 1.15 0 0 0-.362-.825L2.788 8.49l6.85-6.535c.225-.22.362-.518.362-.824C10 .498 9.481 0 8.836 0c-.323 0-.597.115-.813.326L.411 7.609C.137 7.858.01 8.165 0 8.5c0 .335.137.623.411.882l7.612 7.292Z'
      fill='currentColor'
    />
  </svg>
);
